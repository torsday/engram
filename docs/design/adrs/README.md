...
This directory holds short records of the load-bearing architectural decisions made for engram. Each ADR captures the context, the options considered, the decision made, and the consequences. The goal is to make the *why* recoverable years later --- the design docs show the *what*; ADRs show *why it's that way*.
